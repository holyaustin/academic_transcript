...
<!-- Bootstrap core CSS   <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/bootstrap/4.0.0-alpha.6/css/bootstrap.min.css">
<link rel="stylesheet" type="text/css" href="https://maxcdn.bootstrapcdn.com/bootstrap/3.3.7/css/bootstrap.min.css">
<link href="../css/bootstrap.min.css" rel="stylesheet" media="all">-->

<link href="../css/bootstrap.css" rel="stylesheet" media="all">
<link href="../css/bootstrap-datetimepicker.min.css" rel="stylesheet" media="all">
  <link href="../css/dataTables.bootstrap.css" rel="stylesheet" media="all">
        ...
        <div class="collapse navbar-collapse">
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Entry<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="modules/student/index.php">Student</a></li>
                  <li><a href="modules/subject/index.php">Course</a></li>
                  <li><a href="modules/course/index.php">Grade level</a></li>
                  <li><a href="modules/instructor/index.php">Faculty</a></li>
                  <li><a href="modules/department/index.php">Department</a></li>
                  <li><a href="modules/room/index.php">Rooms</a></li>
                </ul>  
          ...
          <!--   <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Registration<b class="caret"></b></a>
                <ul class="dropdown-menu">
                  <li><a href="newenollment.php">Reservation</a></li>
            ...
            <li class="dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">Class<b class="caret"></b></a>
                <ul class="dropdown-menu">
                   <li><a href="modules/class/index.php">List of class</a></li>
      ...
      <!--       <li class="dropdown">
            ...
            <li class="dropdown">
              ...
              <ul class="dropdown-menu">
                ...
                <li><a href="modules/user/index.php">Manage User</a></li>
