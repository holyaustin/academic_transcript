...
<div class="col-xs-12 col-sm-12 sidebar-offcanvas-middle" id="sidebar" role="navigation">
						   ...
						   <form  method="POST" action="login.php">
								<div class="col-xs-12 col-sm-12">
					            	...
					            	<div class="form-group">
					            		<div class="row" >
					            			<div class="col-xs-12 col-sm-12">
						              			<input type="text" placeholder="Reg. Number/ Matric No" class="form-control" name="uname">
						              		</div>
						            	</div>
						            </div>
						            <div class="form-group">
